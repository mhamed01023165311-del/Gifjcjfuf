  ...
  const projects = [
    {
      ...
      ringIndex: 4.5, 
      label: 'PROJ 01',
      title: 'منصة التجارة الإلكترونية الشاملة',
      desc: 'منصة تسوق إلكتروني متكاملة تعمل على سيرفر وقاعدة البيانات الحيوية. قادرة على إدارة حسابات المستخدمين بالكامل، وبدأت بلوحة تحكم متقدمة ومتطورة لإضافة وتعديل المنتجات بسهولة تامة، متابعة واستقبال الإصدارات والطلبات الجديدة باول، مع إمكانية تعديل ألوان وواجهات المتجر لتجربة تسوق عالمية.',
